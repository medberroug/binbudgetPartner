        ...
        <div v-if="!loader">
            ...
            <div class="" v-for="(choice, index) in rcDay.choices">
                ...
                <div class="flex items-center justify-between px-2 py-4 pr-4 mx-6 mt-4 bg-gray-100 rounded-lg"
                    ...
                    <div class="px-2 py-2 text-white bg-blue-600 rounded-full"
                    ...
                    <div>
                        ...
                        <input type="text" class="text-xs font-semibold disabled:bg-gray-100" disabled v-model="item.name">
                    </div>
                    <div>
                        <p class="text-xs font-semibold text-gray-600">
                            Prix
                        </p>
                        <input type="text" class="text-xs font-semibold disabled:bg-gray-100" disabled v-model="item.price">
                    </div>
                </div>
